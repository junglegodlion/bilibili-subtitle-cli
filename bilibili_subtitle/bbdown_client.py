...
class BBDownClient:
    ...
    def get_video_info(
        ...
        # BBDown 1.6.3 (release) has no --select-lang option (nightly-only).
        # Passing it makes BBDown treat the lang value as an unrecognized
        # command and abort. Download all available subtitles instead;
        # language filtering can be applied on the produced files if needed.
        args.append(url)
